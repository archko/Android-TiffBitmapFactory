...
public class TiffBitmapFactory {
     ...
     * @throws CantOpenFileException     when {@code file} not exist or {@code file} is not tiff image
     ...
     */
    public Bitmap decodeFile(File file) throws CantOpenFileException, DecodeTiffException, NotEnoughtMemoryException {
     ...
     * @throws DecodeTiffException       when error occure while decoding image
     * @throws CantOpenFileException     when {@code file} not exist or {@code file} is not tiff image
     * @throws NotEnoughtMemoryException when {@link Options#inAvailableMemory} not enought to decode image
     * @deprecated Since Android Q is released. You can use this method with scoped storage.
     ...
     * or cannot be decoded into a bitmap, the function returns null.
     */
    public Bitmap decodeFile(File file, Options options) throws CantOpenFileException, DecodeTiffException, NotEnoughtMemoryException {
     ...
     * @throws NotEnoughtMemoryException when for decoding of image system need more memory than {@link Options#inAvailableMemory} or default value
     */
    public Bitmap decodeFileDescriptor(int fileDescriptor) throws CantOpenFileException, DecodeTiffException, NotEnoughtMemoryException {
     ...
     * @throws NotEnoughtMemoryException when for decoding of image system need more memory than {@link Options#inAvailableMemory} or default value
     */
    public Bitmap decodeFileDescriptor(int fileDescriptor, Options options) throws CantOpenFileException, DecodeTiffException, NotEnoughtMemoryException {
    ...
    private native Bitmap nativeDecodeFD(int fd, Options options, IProgressListener listener);
    ...
    public static final class Options {
         ...
         * <p>For storing orientation uses {@link Orientation ImageOrientation} enum</p>
        ...
        /**
         * The number of pixels per {@link Options#outResolutionUnit} in the ImageWidth direction.
         */
        public float outXResolution;

        /**
         * The number of pixels per {@link Options#outResolutionUnit} in the ImageHeight direction.
         */
